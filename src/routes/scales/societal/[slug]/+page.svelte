<!-- /src/routes/scales/societal/[slug]/+page.svelte -->
<script lang="ts">
  ...
  const translations = {
    en: {
      ...
      backToSocietal: "Back to Societal Commons",
      societalCommons: "Societal Commons"
    },
    sv: {
      fallbackNotice: "OBS: Svensk översättning inte tillgänglig ännu. Visar engelsk version.",
      backToSocietal: "Tillbaka till Samhälleliga Allmänningar",
      societalCommons: "Samhälleliga Allmänningar"
    }
  };
  ...
  <div class="max-w-4xl mx-auto px-4 py-16">
    ...
    <nav class="mb-8 text-sm">
      <ol class="flex items-center gap-2 text-earth-600">
        ...
        <li>
          <a href="{base}/scales/societal" class="hover:text-moss-600 transition-colors">{t.societalCommons}</a>
        </li>
        <li class="text-earth-400">/</li>
