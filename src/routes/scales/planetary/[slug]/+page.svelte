<!-- /src/routes/scales/planetary/[slug]/+page.svelte -->
<script lang="ts">
  ...
  const translations = {
    en: {
      ...
      backToPlanetary: "Back to Planetary Commons",
      planetaryCommons: "Planetary Commons"
    },
    sv: {
      fallbackNotice: "OBS: Svensk översättning inte tillgänglig ännu. Visar engelsk version.",
      backToPlanetary: "Tillbaka till Planetära Allmänningar",
      planetaryCommons: "Planetära Allmänningar"
    }
  };
...
<div class="min-h-screen" in:fade>
  <SEO
    ...
    section={t.planetaryCommons}
    keywords="planetary commons, global governance, digital commons, climate, biosphere"
  />
